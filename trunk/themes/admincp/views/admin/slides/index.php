<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo translate('Trình diễn');?></li>
		</ul>
	</div>
	...
	<div class="page-content">
		<div class="row-fluid">
			<div class="span12">
			<div class="row-fluid">
			<?php $is_product = (isset($_GET['is_product'])) ? $_GET['is_product'] : null;
				if($is_product == null) $is_product = 1;
			?>
			<?php $form = $this->beginWidget('CActiveForm', array(
					'id'=>'slides-form',
					'htmlOptions'=>array('class'=>'form-horizontal', 'enctype'=>'multipart/form-data'),
					'action' => PIUrl::createUrl('/admin/slides/index', array('is_product'=> $is_product)),
				)); ?>
				<div class="widget-box  collapsed">
					<div class="widget-header">
						<h4><?php 
							if($is_product == 1)  echo   "Thêm hình ảnh hoạt động";
							if($is_product == 2)  echo   "Thêm hình ảnh sản phẩm mới";
							if($is_product == 3)  echo   "Thêm hình ảnh trình diễn";
						?></h4>
				...
				<?php if(!empty($model)){ foreach($model as $image):?>
					<li>
						...
						<div class="tools tools-bottom">
							...
							<a href="<?php echo PIUrl::createUrl('/admin/slides/delete/',array('id'=>$image->id, 'is_product'=>$is_product));?>" class="delete">
