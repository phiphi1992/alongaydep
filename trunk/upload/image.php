...
/*
* Cập nhật bởi Phihx. Date 02/04/2014.
* File dùng để get image của property pro gồm 2 loại echo thumb
* và echo hình với các tham số sau:
* @id: là id của property
* @w: là Chiều rộng cần lấy
* @h: là chiều cao cần lấy
* ex: "image.php?id=2&w=400&h=600&image=10015_1.jpg";
*/
...
if(! defined('PHOTO_ROOT') )			define('PHOTO_ROOT', '/alongaydep/upload/images/');
if(! defined('PHOTO_PATH') )			define('PHOTO_PATH', $_SERVER['DOCUMENT_ROOT'].'/alongaydep/upload/images/');
/*
...
class timthumb {
	...
	public function __construct(){
		...
		#Added by Phihx
		$this->src = $this->param('image',null);
		...
		if(!file_exists(PHOTO_PATH.$this->src)){
			$this->src =  'no-image.png';
		}
		$imagePath = PHOTO_PATH.$this->src;
	...
	protected function processImageAndWriteToCache($localImage){
		...
		if ($new_width == 0 && $new_height == 0) {
		    $new_width = (int) $this->imageWidth;
		    $new_height = (int) $this->imageHeight;
		}
