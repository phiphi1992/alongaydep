<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo translate('Hỗ trợ trực tuyến');?></li>
		</ul>
	</div>
	...
	<div class="page-content">
		<div class="page-header position-relative">
			<h1>
				<?php echo translate('Danh sách nhóm hỗ trợ');?>
			</h1>
		</div><!--/.page-header-->
		<div class="row-fluid">
			<div class="span12">
			<a href="<?php echo PIUrl::createUrl('/admin/groupSupport/create/');?>" class="btn btn-primary">
				...
				<?php $this->widget('zii.widgets.grid.CGridView', array(
					...
					'columns'=>array(
						...
						array(
							...
							'deleteConfirmation'=>'Bạn có muốn xóa nhóm này không?',
						),
					),
...
<script>
	$("document").ready(function(){
		$(".deleteAll").live('click', function(){
			var arrIdNew = $("#groupSupport-grid").yiiGridView('getSelection');
			if(arrIdNew != ""){
				var answer = confirm ("Bạn có muốn xóa các nhóm được chọn không?");
				if(answer){
					var arrIdNew = $("#groupSupport-grid").yiiGridView('getSelection');
					window.location.href = '<?php echo PIUrl::createUrl('/admin/groupSupport/deleteAll') ?>'+"?id="+arrIdNew;
				}
			}
		});
	})
