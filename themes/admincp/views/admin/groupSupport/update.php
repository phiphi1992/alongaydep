<div class="main-content">
	<div class="breadcrumbs" id="breadcrumbs">
		<ul class="breadcrumb">
			...
			<li class="active"><?php echo translate('Nhóm hổ trợ trực tuyến');?></li>
		</ul>
	</div>
	...
	<div class="page-content">
		<div class="page-header position-relative">
			<h1>
				<?php echo translate('Cập nhập nhóm hổ trợ trực tuyến');?>
			</h1>
		</div><!--/.page-header-->
		<div class="row-fluid">
			<div class="span12">
				...
				<?php $form = $this->beginWidget('CActiveForm', array(
					...
					<div class="control-group">
						...
						<div class="controls">
							<?php echo $form->textField($model,'name',array('placeholder'=>'Tên nhóm')); ?>
...
<script>
	$("#groupSupport-form").submit(function(){
