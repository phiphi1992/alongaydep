<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="row-fluid">
			<div class="span12">
				<a href="<?php echo PIUrl::createUrl('/admin/wards/create/');?>" class="btn btn-primary">
					...
					<?php $this->widget('zii.widgets.grid.CGridView', array(
							...
							'columns'=>array(	
								...
								'ward.title' => array(
									...
									'filter' => CHtml::dropDownList('Wards[province_id]', ' ', Provinces::model()->getData()),
								),
								array(
									...
									'deleteConfirmation'=>'Bạn có muốn xóa quận/huyện này không?',
								),	
							),
						)); ?>
			</form>	
...
<script>
	$("document").ready(function(){
		$(".deleteAll").live('click', function(){
			var arrIdNew = $("#wards-grid").yiiGridView('getSelection');
			if(arrIdNew != ""){
				var answer = confirm ("Bạn có muốn xóa các quận/huyện được chọn không?");
				if(answer){
					var arrIdNew = $("#wards-grid").yiiGridView('getSelection');
					window.location.href = "<?php echo PIUrl::createUrl('/admin/wards/deleteAll/');?>"+"?id="+arrIdNew;
				}
			}
		});
	})
