<div class="main-content">
	...
	<div class="page-content">
		...
		<div class="row-fluid">
			<div class="span12">
			<a href="<?php echo PIUrl::createUrl('/admin/categoriesNews/create/');?>" class="btn btn-primary">
	...
	$("document").ready(function(){
		$(".deleteAll").live('click', function(){
			...
			if(arrIdNew != ""){
				...
				if(answer){
					var arrIdNew = $("#categriesnews-grid").yiiGridView('getSelection');
					window.location.href = '<?php echo PIUrl::createUrl('/admin/categoriesNews/deleteAll') ?>'+"?id="+arrIdNew;
				}
			}
		});
	})
